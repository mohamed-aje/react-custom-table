...
function useTableFilter(data, initialFilters) {
  var _useState3 = react.useState(initialFilters || []),
  ...
  var clearFilter = react.useCallback(function (key) {
    if (key) {
      setFilterConfig(function (prevConfig) {
  ...
  var clearAllFilters = react.useCallback(function () {
    setFilterConfig([]);
    setGlobalSearchTerm('');
  }, []);
  return {
...
function useTablePagination(data) {
  ...
  var _useState9 = react.useState(initialPageSize),
  ...
  var resetPagination = react.useCallback(function () {
    setCurrent(1);
  }, []);
...
function useTableSelection(data) {
  ...
  var getRowKey = react.useCallback(function (record, index) {
  ...
  var handleSelect = react.useCallback(function (record, index, selected) {
    var key = getRowKey(record, index);
    if (type === 'radio') {
  ...
  var handleSelectAll = react.useCallback(function (selected) {
    if (type === 'checkbox') {
  ...
  var isSelected = react.useCallback(function (record, index) {
    var key = getRowKey(record, index);
    return selectedKeys.includes(key);
  }, [selectedKeys, getRowKey]);
  var isAllSelected = react.useMemo(function () {
...
function useDebounce(value, delay) {
  var _useState13 = react.useState(value),
...
var Pagination = function Pagination(_ref) {
  ...
  var renderPageNumbers = function renderPageNumbers() {
    ...
    var _loop = function _loop(i) {
      pages.push(jsxRuntime.jsx("button", {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    "data-testid": testId,
    children: [renderTotal(), jsxRuntime.jsxs("div", {
      ...
      children: [jsxRuntime.jsx("button", {
        ...
        title: "First Page",
        children: jsxRuntime.jsx(md.MdFirstPage, {})
        ...
        children: [jsxRuntime.jsx(md.MdNavigateBefore, {}), locale.pagination.previous]
      }), jsxRuntime.jsx("div", {
        ...
        children: [locale.pagination.next, jsxRuntime.jsx(md.MdNavigateNext, {})]
        ...
        title: "Last Page",
        children: jsxRuntime.jsx(md.MdLastPage, {})
      })]
    }), showSizeChanger && onPageSizeChange && jsxRuntime.jsx("div", {
    ...
    }), showQuickJumper && jsxRuntime.jsxs("div", {
...
var ColumnFilter = function ColumnFilter(_ref) {
  ...
  var _useState3 = react.useState(Array.isArray(value) ? value : ['', '']),
    _useState4 = _slicedToArray(_useState3, 2),
  ...
  return jsxRuntime.jsx("div", {
    ...
    children: jsxRuntime.jsxs("div", {
      ...
      children: [renderFilterInput(), jsxRuntime.jsxs("div", {
        className: styles$3.filterActions,
        children: [jsxRuntime.jsx("button", {
          onClick: handleApply,
          className: styles$3.applyButton,
          title: "Apply Filter",
          children: jsxRuntime.jsx(md.MdCheck, {})
        }), jsxRuntime.jsx("button", {
          onClick: handleClear,
          className: styles$3.clearButton,
          title: "Clear Filter",
          children: jsxRuntime.jsx(md.MdClose, {})
        })]
      })]
    })
  });
...
var MobileCard = function MobileCard(_ref) {
  ...
  var renderCardContent = function renderCardContent(record, index) {
    return jsxRuntime.jsxs("div", {
      ...
      children: [selection && jsxRuntime.jsx("div", {
      ...
      }), actions.length > 0 && jsxRuntime.jsx("div", {
...
var VirtualizedTable = function VirtualizedTable(_ref2) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    }), jsxRuntime.jsx(reactWindow.FixedSizeList, {
      height: height,
...
function Table(_ref) {
  ...
  //Column management
  var processedColumns = react.useMemo(function () {
  ...
  var handleSortClick = react.useCallback(function (columnKey) {
  ...
  var handleFilterChange = react.useCallback(function (columnKey, value, type) {
  ...
  var handleCellCopy = react.useCallback(/*#__PURE__*/function () {
  ...
  var handleExportData = react.useCallback(function () {
  ...
  react.useCallback(function (columnKey, width) {
  ...
  var renderSortIcon = function renderSortIcon(column) {
    ...
    if (!sortState) {
      return jsxRuntime.jsx(md.MdUnfoldMore, {
        className: styles.sortIcon
      });
    }
    return sortState.direction === 'asc' ? jsxRuntime.jsx(md.MdArrowUpward, {
      className: "".concat(styles.sortIcon, " ").concat(styles.sortIconActive)
    }) : jsxRuntime.jsx(md.MdArrowDownward, {
      className: "".concat(styles.sortIcon, " ").concat(styles.sortIconActive)
    });
  };
  var renderCellContent = function renderCellContent(value, record, column, index) {
    ...
    if (column.copyable) {
      ...
      return jsxRuntime.jsxs("div", {
        ...
        }), jsxRuntime.jsx(md.MdContentCopy, {
          className: styles.copyIcon,
          onClick: function onClick() {
            return handleCellCopy(value, cellKey);
          }
        }), jsxRuntime.jsx(reactTooltip.Tooltip, {
    ...
    return jsxRuntime.jsxs("th", {
      ...
      children: [jsxRuntime.jsxs("div", {
        ...
        children: [jsxRuntime.jsx("span", {
          ...
          children: column.title
        }), renderSortIcon(column), column.filterable && jsxRuntime.jsx(md.MdFilterList, {
      ...
      }), filterVisible[column.key] && jsxRuntime.jsx(ColumnFilter, {
        column: column,
  ...
  var renderSelectionColumn = function renderSelectionColumn() {
    ...
    return jsxRuntime.jsx("th", {
      ...
      children: rowSelection.type === 'checkbox' && jsxRuntime.jsx("div", {
        className: styles.checkboxContainer,
        children: selection.isAllSelected ? jsxRuntime.jsx(md.MdCheckBox, {
          className: styles.checkbox,
          onClick: function onClick() {
            return selection.handleSelectAll(false);
          }
        }) : selection.isIndeterminate ? jsxRuntime.jsx(md.MdIndeterminateCheckBox, {
          className: styles.checkbox,
          onClick: function onClick() {
            return selection.handleSelectAll(true);
          }
        }) : jsxRuntime.jsx(md.MdCheckBoxOutlineBlank, {
          className: styles.checkbox,
          onClick: function onClick() {
            return selection.handleSelectAll(true);
          }
  ...
  var renderSelectionCell = function renderSelectionCell(record, index) {
    ...
    return jsxRuntime.jsx("td", {
      ...
      children: jsxRuntime.jsx("div", {
        className: styles.checkboxContainer,
        children: isSelected ? jsxRuntime.jsx(md.MdCheckBox, {
  ...
  if (loading) {
    return jsxRuntime.jsx("div", {
      ...
      children: loadingComponent || jsxRuntime.jsxs("div", {
        className: styles.loadingSpinner,
        children: [jsxRuntime.jsx(md.MdRefresh, {
  ...
  if (isMobile && mobileCardView) {
    return jsxRuntime.jsx(MobileCard, {
      data: paginatedData,
  ...
  if (virtualization.enabled && filteredData.length >= (virtualization.threshold || 1000)) {
    return jsxRuntime.jsx(VirtualizedTable, {
      data: filteredData,
      columns: processedColumns,
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsxs("div", {
      ...
      children: [title && jsxRuntime.jsx("h2", {
        ...
        children: [globalSearch && jsxRuntime.jsxs("div", {
          ...
          }), globalSearchTerm && jsxRuntime.jsx(md.MdClear, {
            className: styles.clearSearchButton,
            onClick: function onClick() {
              return setGlobalSearchTerm('');
            }
          })]
        }), (filterConfig.length > 0 || globalSearchTerm) && jsxRuntime.jsxs("button", {
          className: styles.clearFiltersButton,
          onClick: clearAllFilters,
          "data-testid": "".concat(testId, "-clear-filters"),
          children: [jsxRuntime.jsx(md.MdClear, {}), " Clear Filters"]
        }), permissions["export"] && (exportConfig || onExport) && jsxRuntime.jsxs("button", {
          className: styles.exportButton,
          onClick: handleExportData,
          "data-testid": "".concat(testId, "-export"),
          children: [jsxRuntime.jsx(md.MdFileDownload, {}), " ", mergedLocale.exportCSV]
        })]
      })]
    }), displayData.length > 0 ? jsxRuntime.jsx("div", {
      ...
      children: jsxRuntime.jsxs("table", {
        ...
        children: [jsxRuntime.jsx("thead", {
          children: jsxRuntime.jsxs("tr", {
            children: [renderSelectionColumn(), processedColumns.map(renderHeaderCell), actions.length > 0 && jsxRuntime.jsx("th", {
              className: styles.tableHeader,
              children: "Actions"
            })]
          })
          ...
          children: displayData.map(function (record, index) {
            return jsxRuntime.jsxs("tr", {
              ...
              }), actions.length > 0 && jsxRuntime.jsx("td", {
                className: styles.tableCell,
                children: jsxRuntime.jsx("div", {
      ...
      "data-testid": "".concat(testId, "-empty"),
      children: emptyState || jsxRuntime.jsxs("div", {
        className: styles.emptyStateContent,
        children: [jsxRuntime.jsx(md.MdFilterList, {
          className: styles.emptyStateIcon
        }), jsxRuntime.jsx("p", {
          children: mergedLocale.noData
        })]
      })
    }), pagination !== false && total > (pagination.pageSize || 10) && jsxRuntime.jsx(Pagination, {
      current: current,
      total: total,
      pageSize: pageSize,
      totalPages: totalPages,
